...
public abstract class FileDataOutputPrinter implements DataOutputPrinter {
    ...
    public static void print(Geometric2DShape shape, String outputPath) throws IOException {
        ...
        Map<String, Double> properties = shape.parameters();
        ...
        for (Map.Entry<String, Double> entry : properties.entrySet()) {
            ...
            if (key != null)
                bw.write(newLine + newLine + key + ": " + entry.getValue());
        }
